...
class UserBooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_book" do
    assert_difference('UserBook.count') do
      post user_books_url, params: { user_book: { isFavorite: @user_book.isFavorite, readstatus: @user_book.readstatus } }
    end
  ...
  test "should update user_book" do
    patch user_book_url(@user_book), params: { user_book: { isFavorite: @user_book.isFavorite, readstatus: @user_book.readstatus } }
